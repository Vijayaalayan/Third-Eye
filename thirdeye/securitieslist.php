...
$result = mysqli_query($connection,"SELECT * FROM securitylist");
?>
<!DOCTYPE html>
<html>
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Security Guard Details</h3>
            </div>
              ...
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  ...
                  <th scope="col" class="sort" data-sort="name">NO</th>
                    ...
                    <th scope="col" class="sort" data-sort="name">Security Name</th>
                    <th scope="col" class="sort" data-sort="budget">Age</th>
                    <th scope="col" class="sort" data-sort="budget">Shift</th>
                ...
                <?php
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td><?php echo $row["securityname"]; ?></td>
                            ...
                            <td>
                            <a id="del" href="securitydelete.php?contactno=<?php echo $row["contact"]; ?>">Delete</a>
                            </td>
                            </tr>
                            <?php $count++; }
