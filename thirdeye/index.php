...
.slider {
    ...
    width: 100%;
    height: 100vh;
    background: linear-gradient(to right,#ec008c,#fc6767,white);
    z-index: -1;
}
...
<body>
    ...
    <header>
        <nav>
            <h3 id="logo">Zero Buggers</h3>
            <img class="Zero_Buggers" src="assets/img/brand/zbg.png" width="100px" alt="Zero_Buggers">
        </nav>
        <section>
            <div class="logo">
                <img class="logimg" src="assets/img/brand/thirdeyeindex.jpg" alt="Thirdeye">
