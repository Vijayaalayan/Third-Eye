          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Security Guard </h3>
                </div>
            ...
            <div class="card-body">
                      ...
                      {	 
                        ...
                        $sql = "INSERT INTO securitylist (securityname,age,shift,contact)
                        VALUES ('$securityname','$age','$shift','$contact')";
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" name="securityname" class="form-control"  placeholder="Name">
                      </div>
                    </div>
                    <!-- <div class="col-lg-6">
                      <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-username" name="age" class="form-control"  placeholder="40">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">SHift</label>
                        <input type="text" id="input-first-name" name="shift" class="form-control"  placeholder="Day/Night">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Contact Number</label>
                        <input type="text" id="input-last-name" name="contact" class="form-control"  placeholder="12345*****">
                      </div>
                    </div>
